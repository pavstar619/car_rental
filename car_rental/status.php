...
<body>
		...
		<h2 style="text-decoration:underline">Your Booking Status</h2>
			...
			?>
				<li>
						...
						<h2 style="font-size:30px;">Client Details:</h2>
						<h3><span>Client ID: <?php echo $rws['client_id'];?></span></h3>
						<h3><span>Full Name: <?php echo $rws['fname'];?></span></h3>
						<h3><span>Email: <?php echo $rws['email'];?></span></h3>
						<h3><span>NID No.: <?php echo $rws['id_no'];?></span></h3>
						<h3><span>Phone: <?php echo $rws['phone'];?></span></h3>
						<h3><span>Location: <?php echo $rws['location'];?></span></h3>
						<h3><span>Gender: <?php echo $rws['gender'];?></span></h3>
						<h3><span>Car ID: <?php echo $rws['car_id'];?></span></h3>
						<h3><span>Transaction ID: <?php echo $rws['transaction_id'];?></span></h3>
				</li>
			</ul>
		</div>
	...
	<footer>
		...
		<div class="copyrights wrapper">
			Copyright © 2020 AutoCars — Sanian Mahir Khan All Rights Reserved
		</div>
	</footer><!--  end footer  -->
